    ...
    runners: [
      {
        ...
        priority: 0,
        back: [
          { level: 2, price: 2.06, size: 60 },
          { level: 1, price: 2.04, size: 244 },
          { level: 0, price: 2.02, size: 870 },
        ],
        lay: [
          { level: 0, price: 2.08, size: 6 },
          { level: 1, price: 2.1, size: 103 },
          { level: 2, price: 2.12, size: 102 },
        ],
      },
      {
        _id: nanoid(),
        ...
        priority: 0,
        back: [
          { level: 2, price: 1.92, size: 45 },
          { level: 1, price: 1.91, size: 64 },
          { level: 0, price: 1.9, size: 114 },
        ],
        lay: [
          { level: 0, price: 1.93, size: 32 },
          { level: 1, price: 1.94, size: 32 },
          { level: 2, price: 1.96, size: 28 },
        ],
      },
    ],
  },
